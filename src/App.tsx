        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-[#121215] border border-[#333339] space-y-2">
                <div className="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider flex items-center justify-between">
                  ...
                  {isFetchingSubdomain && <span className="text-brand font-mono text-[10px] flex items-center gap-1"><RefreshCw className="w-3 h-3 animate-spin" /> Detecting Subdomain...</span>}
                </div>
            ...
            <div className="flex justify-between pt-4 border-t border-[#333339]">
              ...
              <button
                onClick={() => setStep(3)}
                disabled={!adminUsername || !adminPassword || !workerName}
                className="px-6 py-2.5 bg-brand text-white rounded-lg text-xs font-semibold hover:bg-brand-hover disabled:opacity-50 flex items-center gap-2"
              >
